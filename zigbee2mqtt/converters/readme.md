...
Поддержка нового устройства в Z2M реализуется написанием внешнего конвертера на языке JavaScript. Внешний конвертер копируется в папку Z2M и регистрируется на странице Настройки>Внешние конвертеры.
