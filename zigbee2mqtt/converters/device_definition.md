...
Определение устройства представляет собой структуру JavaScript, содержащую предопределенный набор значений.
...
| onEvent      | Функция обработки низкоуровневых событий Z2M, например остановки Z2M | |
