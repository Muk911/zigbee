...
Объект конвертера fromZigbee должна содержать переменные:
...
#### toZigbee ####
Переменная toZigbee содержит массив конвертеров, описывающих логику преобразования событий топиков MQTT в операции чтения/записи значений атрибутов и выполнения команд кластеров устройства.
...
Объект конвертера toZigbee должна содержать переменные:
