...
#### fromZigbee ####
Переменная fromZigbee содержит конвертеры, описывающие логику преобразования значений атрибутов и команд кластеров устройства в операции публикации в топики MQTT.
#### toZigbee ####
Переменная toZigbee содержит конвертеры, описывающие логику преобразования событий топиков MQTT в операции чтения/записи значений атрибутов и выполнения команд кластеров устройства.
