...
#### endpoint ####
Переменная endpoint содержит функцию, возвращающую структуру маппинга имен конечных точек устройства и номеров конечных точек. Эта информация используется для формирования имен свойств в функциях преобразования конвертера. Имена конечных точек в функции endpoint и имена конечных точек в определениях exposes должны соответствовать друг другу.
