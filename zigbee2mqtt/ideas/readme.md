...
Если для "прямых" решений, например Zigbee Home Automation (ZHA) непосредственно используется модель данных Home Assistant, для решений с использованием MQTT необходимы некие абстрактные элементы, которые 
