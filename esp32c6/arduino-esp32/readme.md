# Разработка Zigbee устройств на ESP32-C6/C5/H2 в среде Arduino IDE

## Установка Arduino IDE и расширения для ESP32-C6/C5/H2 ###
...
## Подключение модуля ###
1. Подключите модуль ESP32-C6/C5/H2 к ПК через UART. На отладочных модулях ESP32-C6/H2 DevKit имеется встроенный преобразователь USB-UART, выведенный на USB Type-C разъем с надписью "UART". Для подключения "голых" модулей необходим внешний преобразователь USB-UART.
