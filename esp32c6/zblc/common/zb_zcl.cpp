...
/*
  #ifdef USE_FAN_CONTROL_CLUSTER
    static int16_t fanMode = 0x05;
    static int16_t fanModeSequence = 0x02;
    static zb_attr_info_t a202[] = {
      {ESP_ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_ID, ESP_ZB_ZCL_ATTR_TYPE_8BIT_ENUM, ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, true, &fanMode},
      {ESP_ZB_ZCL_ATTR_FAN_CONTROL_FAN_MODE_SEQUENCE_ID, ESP_ZB_ZCL_ATTR_TYPE_8BIT_ENUM, ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, true, &fanModeSequence}
    };
    addClusterAttrs(ESP_ZB_ZCL_CLUSTER_ID_FAN_CONTROL, a202, sizeof(a202)/sizeof(zb_attr_info_t));
  #endif // USE_IDENTIFY_CLUSTER
*/
    ...
    static zb_attr_info_t a402[] = {
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_ID,      ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_RP,        true,  &uint16Unknown}, 
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_MIN_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown},
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_MAX_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown},
    ...
    static zb_attr_info_t a403[] = {
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_VALUE_ID,             ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_RP,        true,  &uint16Unknown}, //MinMeasuredValue – MaxMeasuredValue 
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MIN_VALUE_ID,         ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown}, //0x8001– 0x7ffe
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MAX_VALUE_ID,         ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown}, //0x8002– 0x7fff
      {0x0003,                                                    ESP_ZB_ZCL_ATTR_TYPE_U16,    ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uintZero}, //0x0000 – 0x0800
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_SCALED_VALUE_ID,      ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uintZero}, //MinScaledValue – MaxScaledValue
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MIN_SCALED_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uint16Unknown}, //0x8001-0x7ffe
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MAX_SCALED_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_S16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uint16Unknown}, //0x8002-0x7fff
      ...
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_SCALE_ID,             ESP_ZB_ZCL_ATTR_TYPE_S8,   ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uintZero} //0x81 – 0x7f
    };
    ...
    static zb_attr_info_t a201[] = {
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_LOCAL_TEMPERATURE_ID,                     ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_RP,         true,  &uintZero},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_OUTDOOR_TEMPERATURE_ID,                   ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &uintZero},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_OCCUPANCY_ID,                             ESP_ZB_ZCL_ATTR_TYPE_8BITMAP,   ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &uintZero},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_ABS_MIN_HEAT_SETPOINT_LIMIT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &absMinHeatSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_ABS_MAX_HEAT_SETPOINT_LIMIT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &absMaxHeatSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_ABS_MIN_COOL_SETPOINT_LIMIT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &absMinCoolSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_ABS_MAX_COOL_SETPOINT_LIMIT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &absMaxCoolSetpointLimit},
      ...
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_LOCAL_TEMPERATURE_CALIBRATION_ID,         ESP_ZB_ZCL_ATTR_TYPE_S8,      ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &uintZero},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_OCCUPIED_COOLING_SETPOINT_ID,             ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_RWS,        false, &occupiedCoolingSetpoint},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_OCCUPIED_HEATING_SETPOINT_ID,             ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_RWS,        true,  &occupiedHeatingSetpoint},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_UNOCCUPIED_COOLING_SETPOINT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &unoccupiedCoolingSetpoint},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_UNOCCUPIED_HEATING_SETPOINT_ID,           ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &unoccupiedHeatingSetpoint},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_MIN_HEAT_SETPOINT_LIMIT_ID,               ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &minHeatSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_MAX_HEAT_SETPOINT_LIMIT_ID,               ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &maxHeatSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_MIN_COOL_SETPOINT_LIMIT_ID,               ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &minCoolSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_MAX_COOL_SETPOINT_LIMIT_ID,               ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &maxCoolSetpointLimit},
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_MIN_SETPOINT_DEAD_BAND_ID,                ESP_ZB_ZCL_ATTR_TYPE_S8,      ESP_ZB_ZCL_ATTR_ACCESS_READ_WRITE, false, &minSetpointDeadBand},
      ...
      {ESP_ZB_ZCL_ATTR_THERMOSTAT_AC_COIL_TEMPERATURE_ID,                   ESP_ZB_ZCL_ATTR_TYPE_S16,     ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY,  false, &uintZero},
