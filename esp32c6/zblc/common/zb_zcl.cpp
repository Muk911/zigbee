...
void fillInfo()
{
    ...
    static zb_attr_info_t a402[] = {
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_ID,      ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_RP,        true,  &uint16Unknown}, 
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_MIN_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown},
      {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_MAX_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown},
    ...
    static zb_attr_info_t a403[] = {
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_VALUE_ID,             ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_RP,        true,  &uint16Unknown}, //MinMeasuredValue – MaxMeasuredValue 
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MIN_VALUE_ID,         ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown}, //0x8001– 0x7ffe
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MAX_VALUE_ID,         ESP_ZB_ZCL_ATTR_TYPE_U16,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, true,  &uint16Unknown}, //0x8002– 0x7fff
