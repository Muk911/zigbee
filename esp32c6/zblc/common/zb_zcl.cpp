...
void fillInfo()
{
    ...
    static zb_attr_info_t a403[] = {
      ...
      {ESP_ZB_ZCL_ATTR_PRESSURE_MEASUREMENT_MAX_SCALED_VALUE_ID,  ESP_ZB_ZCL_ATTR_TYPE_16BIT,  ESP_ZB_ZCL_ATTR_ACCESS_READ_ONLY, false, &uint16Unknown}, //0x8002-0x7fff
